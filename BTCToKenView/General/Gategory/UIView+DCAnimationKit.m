...
{
    [self bounce:8 finished:finished];
}
//////////////////////////////////////////////////////////////////////////////////////
-(void)bounce:(CGFloat)height finished:(DCAnimationFinished)finished
{
    ...
    [self moveY:-height duration:0.4 finished:^{
...
//////////////////////////////////////////////////////////////////////////////////////
-(void)bounceDown:(DCAnimationFinished)finished
{
    [self bounceDown:-8 finished:finished];
}
//////////////////////////////////////////////////////////////////////////////////////
-(void)bounceDown:(CGFloat)height finished:(DCAnimationFinished)finished
{
    UIDynamicAnimator *animator = [self dc_animator];
    [animator removeAllBehaviors];
    [self moveY:-height duration:0.4 finished:^{
